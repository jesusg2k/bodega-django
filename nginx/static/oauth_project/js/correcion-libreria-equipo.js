    ...
    window.onload = function () {
        ...
        for (let i = 0; i < inputs.length; i++) {
            ...
            inputs[i].innerHTML = inputs[i].innerHTML.replaceAll("Add Another", "Agregar otro")
            inputs[i].textContent = inputs[i].textContent.replaceAll("Add Another", "Agregar otro")
        }
