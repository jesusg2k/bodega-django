    ...
    def test_user_register_success(self):
        ...
        try:
            WebDriverWait(self.driver, 2)\
                .until(EC.url_matches(self.live_server_url+'/crearusuario/'))
        except TimeoutException:
            print("Creacion del user fallo")
        finally:
            self.assertURLEqual(self.driver.current_url, self.live_server_url+'/crearusuario/')
